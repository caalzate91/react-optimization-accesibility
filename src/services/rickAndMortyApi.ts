...
// ====================================================================
// FUNCIÓN CORREGIDA PARA MANEJAR ENTORNOS (Vite vs. Jest/Node)
// ====================================================================
const shouldUseMockApi = () => {
    // Si estamos en el entorno Node/Jest (no hay 'window'), usamos process.env.
    // Esto es NECESARIO para evitar el "SyntaxError: Cannot use 'import.meta' outside a module".
    if (typeof window === 'undefined') {
        return process.env.VITE_USE_MOCK_API === 'true'; 
    }

    // Si estamos en el navegador (Vite), usamos import.meta.env.
    // Esta línea solo se ejecuta si 'window' existe.
